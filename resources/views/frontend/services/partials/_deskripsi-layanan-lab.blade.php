{{-- resources/views/frontend/services/partials/_deskripsi-layanan-lab.blade.php --}}
    ...
    <div class="card-body p-5">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                ...
                <ul class="list-unstyled">
                    <li class="d-flex"><i class="bi bi-tools text-info me-2"></i> Leco S832</li>
                    <li class="d-flex"><i class="bi bi-tools text-info me-2"></i> Leco AC600</li>
                    <li class="d-flex"><i class="bi bi-tools text-info me-2"></i> Oven Mini Free Space</li>
                    <li class="d-flex"><i class="bi bi-tools text-info me-2"></i> Analytical balance</li>
                    <li class="d-flex"><i class="bi bi-tools text-info me-2"></i> Carbolite Volatile Matter Furnace (VMF)</li>
                    <li class="d-flex"><i class="bi bi-tools text-info me-2"></i> Carbolite Ashing Furnace (AAF)</li>
                </ul>
            </div>
        </div>
    </div>
