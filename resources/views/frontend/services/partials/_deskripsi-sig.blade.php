{{-- resources/views/frontend/services/partials/_deskripsi-sig.blade.php --}}
<div class="card card-service shadow-lg border-0 mb-5">
    <div class="card-body p-5">
        <div class="d-flex align-items-start mb-4">
            <i class="bi bi-map-fill text-info me-4 fs-1"></i>
            <div>
                <h3 class="fw-bold text-secondary mb-0">Layanan Pengolahan Data Spasial (SIG)</h3>
                <p class="text-muted small">Layanan pemetaan dan analisis data geografis untuk mendukung perencanaan dan pengambilan keputusan.</p>
            </div>
        </div>
